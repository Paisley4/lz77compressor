...
public:
    ...
    static bool contain_word(const char *tab, const __int64 &lookahead_buf, const __int64 &window_position, const __int64 &end, lz77_word &word);
    static void copy_array(char *tab, const __int64 &window_position, const __int64 &lookahead_buf, const __int64 &begin, const __int64 &n);
    static void copy_array(std::vector<char> &tab, const __int64 &window_position, const __int64 &lookahead_buf, const __int64 &begin, const __int64 &n);
